...
public class ControllerMyGrades {
    ...
    private void addNewCourse() {
        try {
            Course addedCourse = new Course(
                    ...
                    Double.parseDouble(newCoursePoints.getText()));
    ...
    /**
     * Setup the primary table with all column values, then input data into the table.
     */
    @FXML
    ...
    /**
     * Configure and open a JFileChooser window that the user can then use to pick a file location
     * to export file into.
     */
    @FXML
