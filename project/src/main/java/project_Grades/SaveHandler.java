...
public interface SaveHandler {
	...
	/**
	 * Print all courses in the Student object sent to a .csv file in the User/GradesApplication/Export folder.
	 * @param filePath A string that specifies the path of the output file.
	 * @param fileName A string that specifies what the name of the output .csv will be called.
	 * @param courseCollection The Student object we wish to convert into a .csv file.
	 * @throws IOException If the write area is inaccessable or read-only a IOException will be thrown.
	 */
	void save(String filePath, String fileName, Student courseCollection) throws IOException;
	 ...
	 */
	void load(String fileName, Student readToObject) throws FileNotFoundException, IOException;
	 ...
	 * @throws IOException If program cannot make required folders. Check if area is writeable.
	 */
	void loadSpecifiedFile(String pathName, Student readToObject) throws FileNotFoundException, IOException;
}
