...
public class SaveFileCSVTest {
	...
	void writeToFile() throws FileNotFoundException, IOException {
		...
		File testFileCSV = new File(System.getProperty("user.home")+"\\GradesApplication\\Export\\"+testFile+".csv");
	...
	void writeToCSVFile() throws FileNotFoundException, IOException {
	...
	void deleteFile() throws FileNotFoundException, IOException {
		...
		Assertions.assertThrows(FileNotFoundException.class, () ->
				{writerCSV.deleteFile(testFile);}, "Should not have been able to delete a non-existant file.");
	}
}
