...
public class SaveUserDataTest {
	...
	void writeToFile() throws FileNotFoundException, IOException {
		...
		File testFileUserData = new File(System.getProperty("user.home")+"\\GradesApplication\\UserData\\"+testFile+".MGD");
	...
	void deleteFile() throws FileNotFoundException, IOException {
		...
		Assertions.assertThrows(FileNotFoundException.class, () ->
				{writerUserData.deleteFile(testPerson);}, "Should not have been able to delete a non-existant file.");
	}
}
